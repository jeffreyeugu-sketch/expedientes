// JavaScript para Detalle del Paciente y Historial de Consultas
 ...
 * @param {string} estado - Estado a filtrar: 'todas', 'completada', 'programada', 'en_curso'
 */
...
function cancelarConsulta(consultaId) {
    ...
    const motivo = prompt('¿Por qué deseas cancelar esta consulta?\n\n(Opcional: Escribe el motivo)');
    
    if (motivo !== null) { // null = usuario canceló el prompt
        // Aquí iría la llamada AJAX al backend para cancelar
        console.log('Cancelando consulta:', consultaId, 'Motivo:', motivo);
        
        // Simulación de cancelación exitosa
        alert('Consulta cancelada exitosamente.\n\nEsta funcionalidad se completará pronto.');
        
        // TODO: Implementar llamada AJAX real
        // fetch(`/api/consultas/${consultaId}/cancelar/`, {
        //     method: 'POST',
        //     headers: {
...
function imprimirConsulta(consultaId) {
    ...
    // O abrir vista de impresión optimizada
}
...
function cargarMasConsultas() {
    ...
    setTimeout(() => {
        ...
        alert('Funcionalidad de paginación próximamente.\n\nCargará las siguientes 10 consultas.');
    }, 1500);
    
    // TODO: Implementar carga AJAX real
    // fetch('/api/pacientes/consultas/?offset=10&limit=10')
    //     .then(response => response.json())
    //     .then(data => {
    //         // Agregar nuevas consultas al timeline
    //         // Actualizar contador
    //     });
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Detectar si hay consultas de hoy para resaltar
...
// ===========================================
// ANIMACIONES CSS (agregar al <head> si es necesario)
// ===========================================
